                ...
                <tbody>
                    ...
                    if ($fieldsOrdered) {
                        foreach ($fieldsOrdered as $value) {
                            ?>
                            <tr>
                                <td> <input  type="checkbox" class="chk" name="fields_list[<?php echo $value['name'] ?>]"  value="1"
                                    <?php
                                ...
                                <td>
                                    ...
                                    foreach ($languages as $language) {
                                        ...
                                        <div class="titleinputdiv titleinputdiv_<?php echo $language->code ?>" <?php
                                             ...
                                             ?>>
                                            <input  type="text" name="title[<?php echo $value['name']; ?>][<?php echo $language->code ?>]"  value="<?php if ($value[$fieldName]) echo htmlentities($value[$fieldName], ENT_QUOTES, "UTF-8"); ?>" class="form-control"></input>
